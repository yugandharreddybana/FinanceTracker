          ...
          >
            ...
            <div className="flex-1 min-w-0 relative z-10">
              ...
              <p className="text-xs text-white/40 font-mono font-medium mb-3">
                <span className="text-white font-bold">{goal.current.toLocaleString('en-US', { style: 'currency', currency: goal.currency || 'USD' })}</span>
                <span className="mx-1">/</span>
                <span>{goal.target.toLocaleString('en-US', { style: 'currency', currency: goal.currency || 'USD' })}</span>
              </p>
